<?php 
    ...
    if(isset($_GET['PapsId'])){
      ...
      $querydelete=mysqli_query($con,"delete from tblpaps where PapsId='$PapsId'")or die(mysql_error());
        if($querydelete)
        {
            $_SESSION['check']=2;
            echo '<script>
    ...
    <div class="col-xs-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">List of Paps
                <a class="heading-elements-toggle"><i class="icon-ellipsis font-medium-3"></i></a>
                <a href="paps_insert" class="btn btn-primary" style="float:right;"> Add Paps</a>
                </h4>
            </div>
                    ...
                    <tbody>
                        ...
                        ?>
                         ...
                         <?php
                            ...
                            ?></td>
                            <td>
                                <a href="paps_edit.php?PapsId=<?php echo $row['PapsId']; ?>"><i class="ficon icon-pencil2"></i></a>
                                <a title="Delete" data-toggle="modal" data-target="#myModal" onClick="delete1(<?php echo $row['PapsId']; ?>)"> <i class="ficon icon-bin"></i></a>
                            </td>
                         </tr>      
                            <?php
                                    $i++;
...
<SCRIPT>
function delete1(PapsId)
{
	$('#deleteYes').attr('href','paps_list.php?PapsId='+PapsId);	
}
