<?php 
    ...
    if(isset($_GET['TestimonialId']))
    {
        ...
        $queryselect=mysqli_query($con,"select * from tbltestimonial where TestimonialId='$TestimonialId'")or die(mysql_error());
        $r1=mysqli_fetch_array($queryselect);
        $TestimonialImage=$r1['TestimonialImage'];
        if($TestimonialImage!='' || $TestimonialImage==null)
        {
            $querydelete=mysqli_query($con,"delete from tbltestimonial where TestimonialId='$TestimonialId'")or 
            die(mysql_error());
            unlink("upload/TestimonialImages/".$r1['TestimonialImage']);
        }
        else
        {
            $querydelete=mysqli_query($con,"delete from tbltestimonial where TestimonialId='$TestimonialId'")or 
                        ...
                        ?>
                         ...
                         <?php
                            ...
                            <td>
                                        ...
                                        {
                                            ?>
                                            <img src="upload/TestimonialImages/<?php echo $row['TestimonialImage']; ?>" alt="" height="70" width="70">
                                        <?php
                                        }
                                        ?>
                                    </td>
                            ...
                            ?></td>
                            <td>
                                <a href="testimonial_edit?TestimonialId=<?php echo $row['TestimonialId']; ?>"><i class="ficon icon-pencil2"></i></a>
                                <a title="Delete" data-toggle="modal" data-target="#myModal" onClick="delete1(<?php echo $row['TestimonialId']; ?>)"> <i class="ficon icon-bin"></i></a>
                            </td>
                         </tr>      
                            <?php
                                    $i++;
...
<SCRIPT>
function delete1(TestimonialId)
{
	$('#deleteYes').attr('href','testimonial_list.php?TestimonialId='+TestimonialId);	
}
